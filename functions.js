...
var imageSrc = "./images/marker_red.png", // 마커이미지의 주소입니다
    imageSize = new kakao.maps.Size(52, 52), // 마커이미지의 크기입니다
    imageOption = {offset: new kakao.maps.Point(26, 26)}; // 마커이미지의 옵션입니다. 마커의 좌표와 일치시킬 이미지 안에서의 좌표를 설정합니다.
...
var content = '<div class="customoverlay">' +
    '  <a href="https://map.kakao.com/link/to/90820395" target="_blank">' +
